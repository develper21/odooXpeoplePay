...
import type { AttendanceRecord, Contract, Employee, Payrun, Payslip, SalaryRule, SalaryStructure, TimeOffAllocation, TimeOffRequest, TimeOffType, User, WorkingSchedule } from "@/types/domain";

export type Store = { employees: Employee[]; contracts: Contract[]; schedules: WorkingSchedule[]; attendance: AttendanceRecord[]; allocations: TimeOffAllocation[]; timeOffRequests: TimeOffRequest[]; timeOffTypes: TimeOffType[]; salaryStructures: SalaryStructure[]; salaryRules: SalaryRule[]; payruns: Payrun[]; payslips: Payslip[]; users: User[] };

export const mockStore: Store = { employees: [...mockEmployees], contracts: [...mockContracts], schedules: [...mockSchedules], attendance: [...mockAttendance], allocations: [...mockTimeOffAllocations], timeOffRequests: [...mockTimeOffRequests], timeOffTypes: [...mockTimeOffTypes], salaryStructures: [...mockSalaryStructures], salaryRules: [...mockSalaryRules], payruns: [...mockPayruns], payslips: [...mockPayslips], users: [...mockUsers] };
