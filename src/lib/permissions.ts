...
export const navigation: NavSection[] = [
  ...
  { label: "HR", items: [{ label: "Employees", href: "/employees", icon: Users, permission: "employee.create" }, { label: "Contracts", href: "/contracts", icon: FileText, permission: "contract.read" }, { label: "Working Schedules", href: "/schedules", icon: CalendarDays, permission: "schedule.read" }, { label: "Attendance", href: "/attendance", icon: ClipboardList, permission: "attendance.update" }] },
  { label: "Time Off", items: [{ label: "Overview", href: "/time-off", icon: CalendarDays, permission: "timeoff.read" }, { label: "Requests", href: "/time-off/requests", icon: ListFilter, permission: "timeoff.read" }, { label: "Allocations", href: "/time-off/allocations", icon: Layers, permission: "timeoff.read" }, { label: "Time Off Types", href: "/time-off/types", icon: ShieldCheck, permission: "timeoff.approve" }] },
