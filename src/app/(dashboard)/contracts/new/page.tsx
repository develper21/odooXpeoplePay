...
export default function NewContractPage() {
  ...
  return (
    <>
      <PageHeader
        title="New Contract"
        description="Connect an employee to a dated wage and salary structure."
      />
      <Card>
        <CardContent className="p-5 sm:p-7">
          <ContractForm
            ...
            onSubmit={async (values) => {
              ...
              router.push(`/employees/${values.employeeId}/contracts`);
            }}
          />
        </CardContent>
      </Card>
      ...
      <p className="sr-only">Existing contracts: {contracts.length}</p>
    </>
  );
}
